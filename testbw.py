...
class MyTopo(Topo):
	def __init__(self):
            ...
            self.addLink(chesterS,manchesterS,delay='4ms',bw='1000m')
            self.addLink(manchesterS,yorkS,delay='6ms',bw='400m')
            self.addLink(manchesterS,nottinghamS,delay='7ms',bw='200m')
            self.addLink(nottinghamS,oxfordS,delay='7ms',bw='100m')
            self.addLink(oxfordS,londonS,delay='4ms',bw='200m')
            self.addLink(londonS,cambridgeS,delay='5ms',bw='300m')
            self.addLink(bristolS,londonS,delay='1ms',bw='200m')
            self.addLink(brightonS,londonS,delay='5ms',bw='100m')
            self.addLink(bristolS,bathS,delay='1ms',bw='400m')
            self.addLink(chesterS,nottinghamS,delay='7ms',bw='300m')
            self.addLink(yorkS,nottinghamS,delay='8ms',bw='200m')
            self.addLink(manchesterS,bristolS,delay='14ms',bw='100m')
            self.addLink(bristolS,oxfordS,delay='7ms',bw='300m')
            self.addLink(bathS,brightonS,delay='10ms',bw='200m')
            self.addLink(oxfordS,cambridgeS,delay='7ms',bw='100m')
            self.addLink(nottinghamS,londonS,delay='10ms',bw='600m')
            self.addLink(nottinghamS,cambridgeS,delay='8ms',bw='400m')
